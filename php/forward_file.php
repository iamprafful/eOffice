<?php
  ...
  {
    $make_transactions_sql = "INSERT INTO transactions (type, file_id, sender_id, receiver_id, forward_status, status, remark)
                             VALUES ($type, $file_id, $user, $send_to, '0', '1', $remark)";
